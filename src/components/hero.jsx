  ...
  useEffect(() => {
    ...
    return (
      <div className="relative flex flex-col justify-center items-center min-h-screen text-white text-center px-4">
          ...
          <div className="hidden md:block animate-fade-in-up absolute top-35 backdrop-blur-sm bg-white/10 border border-white/20 text-white p-4 rounded-full shadow-md w-[240px] text-sm space-y-2 font-mono">
